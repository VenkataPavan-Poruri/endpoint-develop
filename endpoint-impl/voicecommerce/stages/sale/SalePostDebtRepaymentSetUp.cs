...
namespace endpoint_impl.voicecommerce.stages.sale
{
    public class SalePostDebtRepaymentSetUp : SalePostPipelineStageBase
    {
        ...
        private PipelineDebtRepaymentSetUpStageUtility _debtRepaymentSetUpUtility;
        public SalePostDebtRepaymentSetUp(SalePostPipelineStage next, PipelineDebtRepaymentSetUpStageUtility debtRepaymentSetUpUtility) : base(next)
        {
            ...
            _debtRepaymentSetUpUtility = debtRepaymentSetUpUtility;
            _nextStage = new SalePostFundsRecipientCheck(next);            
        }
        protected internal override void stageExecute(SalePostContext context)
        {
            ...
            errorCode = _debtRepaymentSetUpUtility.checkDebtRepayFlag(card, debtRepaymentProfileFlag, terminal);
            isDebtRepayTrans = _debtRepaymentSetUpUtility.isDebtRepaymentTrans(card, terminal, debtRepaymentProfileFlag);
            if (errorCode != null)
            {
