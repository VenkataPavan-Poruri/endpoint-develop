...
namespace endpoint_impl.voicecommerce.stages.sale
{
    public class SalePostCheckCardTerminalStatistics : SalePostPipelineStageBase
    {
        ...
        private readonly PipelineCheckCardTerminalStatisticsStageUtility _cardTerminalStatsUtility;
        ...
        {
            _cardTerminalStatsUtility = cardTerminalStatsUtility;
            _nextStage = new SalePostCheckSchemeTerminalStatistics(next, terminalStatsCheckUtility);
        }
        protected internal override void stageExecute(SalePostContext context)
        {
            ...
            if (cardStats != null)
            {
                if (_cardTerminalStatsUtility.isUnderThreshold(cardStats))
                {
